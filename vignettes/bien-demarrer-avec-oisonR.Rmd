...
> 💡 *Certaines fonctions du package exigent donc des paramètres particuliers pour l'accès aux données (par exemple login, mot de passe, etc...). Pour ne pas saisir ces paramètres à chaque utilisation, il est conseillé de stocker ces éléments directement dans l’environnement `R`* (*cf. procédure ci-dessous*).
