...
#'
#' @return Si collect_all=FALSE, retourne un dataframe avec le code de la région et le nombre d'observation dans celui-ci.
...
get_data_region <- function(region_code, login, mdp, collect_all = FALSE) {

  cli::cli_h1(glue::glue("R\u00e9cup\u00e9ration des donn\u00e9es OISON - region {region_code}"))
